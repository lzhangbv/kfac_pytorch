...
#epochs=100 dnn=resnet110 dataset=cifar10 batch_size=128 lr=0.1 nworkers=4 kfac_name=fast kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=5 clusterprefix=gpu2cluster ./train_cifar10.sh &
epochs=100 dnn=resnet110 dataset=cifar10 batch_size=128 lr=0.1 nworkers=4 kfac_name=fast kfac=0 warmup_epochs=5 clusterprefix=gpu3cluster ./train_cifar10.sh &
